...
public class HWProfile {
    ...
    public final double INTAKE_ANGLE_INIT = 0.20;
    public final double INTAKE_ANGLE_GRAB_SPECIMEN = 0.20;
    ...
    public final int ARM_ANGLE_GRAB_SPECIMEN = -280;
    public final int ARM_ANGLE_PREP_SCORE_SPECIMEN = -1150;
    public final int ARM_ANGLE_SCORE_SPECIMEN = -800;
    public final int ARM_ANGLE_REMOVE_SPECIMEN = -400;
    public final int ARM_ANGLE_SCORE_HIGH_BASKET = -1800;
